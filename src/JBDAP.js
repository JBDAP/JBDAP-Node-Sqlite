 ...
 * @param {Object} conn Sqlite 数据库连接对象
                        ...
                        if (_.isString(item[key])) {
                            switch (item[key]) {
                                ...
                                default: {
                                    ...
                                    // 判断无效的 method
                                    if (item[key].indexOf('JBDAP.fn.') === 0 || item[key].indexOf('JBDAP.sqlite.') === 0) JS.throwError('DBMethodError',null,null,[
